...
*/import"./boot.js";import{PropertyEffects}from"../mixins/property-effects.js";import{MutableData}from"../mixins/mutable-data.js";// Base class for HTMLTemplateElement extension that has property effects
 ...
 */export function templatize(template,owner,options){options=/** @type {!TemplatizeOptions} */options||{};if(template.__templatizeOwner){throw new Error("A <template> can only be templatized once")}template.__templatizeOwner=owner;const ctor=owner?owner.constructor:TemplateInstanceBase;let templateInfo=ctor._parseTemplate(template),baseClass=templateInfo.templatizeInstanceClass;// Get memoized base class for the prototypical template, which
...
node=node.parentNode}}return null}export{TemplateInstanceBase};