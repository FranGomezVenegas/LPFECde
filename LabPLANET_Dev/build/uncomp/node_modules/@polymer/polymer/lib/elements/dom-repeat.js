...
*/import{PolymerElement}from"../../polymer-element.js";import{TemplateInstanceBase,templatize,modelForElement as modelForElement$0}from"../utils/templatize.js";// eslint-disable-line no-unused-vars
import{Debouncer}from"../utils/debounce.js";import{enqueueDebouncer,flush}from"../utils/flush.js";import{OptionalMutableData}from"../mixins/mutable-data.js";import{matches,translate}from"../utils/path.js";import{timeOut,microTask}from"../utils/async.js";/**
 * @constructor
...
inst._setPendingPropertyOrPath(itemPath,value,!1,!0);inst._flushProperties()}return!0}}/**
   ...
   *   the element.
   */modelForElement(el){return modelForElement$0(this.template,el)}}customElements.define(DomRepeat.is,DomRepeat);