...
*/import{PolymerElement}from"../../polymer-element.js";import{templatize}from"../utils/templatize.js";import{Debouncer}from"../utils/debounce.js";import{enqueueDebouncer,flush}from"../utils/flush.js";import{microTask}from"../utils/async.js";import{root as root$0}from"../utils/path.js";/**
...
this.__invalidProps=this.__invalidProps||Object.create(null);this.__invalidProps[root$0(prop)]=!0}}}})}if(!this.__instance){this.__instance=new this.__ctor;parentNode.insertBefore(this.__instance.root,this)}else{this.__syncHostProperties();let c$=this.__instance.children;if(c$&&c$.length){// Detect case where dom-if was re-attached in new position
