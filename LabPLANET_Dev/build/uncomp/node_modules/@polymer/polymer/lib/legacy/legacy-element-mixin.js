...
/**
    ...
    */instanceTemplate(template){let content=this.constructor._contentForTemplate(template),dom=/** @type {!DocumentFragment} */document.importNode(content,!0);return dom}/* **** Begin Events **** */ /**
     ...
     */getEffectiveChildNodes(){const thisEl=/** @type {Element} */this,domApi=/** @type {DomApi} */dom$0(thisEl);return domApi.getEffectiveChildNodes()}/**
     ...
     * @suppress {invalidCasts} LegacyElementMixin must be applied to an HTMLElement
     */queryDistributedElements(selector){const thisEl=/** @type {Element} */this,domApi=/** @type {DomApi} */dom$0(thisEl);return domApi.queryDistributedElements(selector)}/**
     ...
     */getContentChildNodes(slctr){let content=this.root.querySelector(slctr||"slot");return content?/** @type {DomApi} */dom$0(content).getDistributedNodes():[]}/**
...
/**
     ...
     */arrayDelete(arrayOrPath,item){let index;if(Array.isArray(arrayOrPath)){index=arrayOrPath.indexOf(item);if(0<=index){return arrayOrPath.splice(index,1)}}else{let arr=get$0(this,arrayOrPath);index=arr.indexOf(item);if(0<=index){return this.splice(arrayOrPath,index,1)}}return null}// logging
/**
