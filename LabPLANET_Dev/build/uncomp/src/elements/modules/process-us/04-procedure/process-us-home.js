import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import{schema_name,sampleReception_sampleFieldToRetrieve,sampleReception_sampleFieldToDisplay}from"../03config/config-process.js";class processUsHome extends connect(store)(PolymerElement){stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.processUs){//this.unReceivedSamples= state.processUs.unReceivedSamples;
}this.schemaPrefix=schema_name}static get properties(){return{}}static get template(){return html`
        <style>
            p {color: #032bbc;}
            li {margin: 5px;
                color: #032bbc;}
