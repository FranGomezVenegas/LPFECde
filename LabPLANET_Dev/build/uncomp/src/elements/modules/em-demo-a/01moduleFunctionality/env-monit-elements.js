...
import{FrontendEnvMonit}from"./frontend-env-monit.js";import{openEsignDialog}from"../../../app/Redux/actions/esign-actions.js";import{openConfirmUserDialog}from"../../../app/Redux/actions/confirmuser-actions.js";import{schema_name,sampleIncubation_incubBatch_incubatorsFieldToDisplay,sampleCustodian_cocUsersListFieldToRetrieve,sampleCustodian_cocUsersListFieldToDisplay,sampleCustodian_cocUsersListFieldToSort,sampleCustodian_cocSampleHistoryFieldToRetrieve,sampleCustodian_cocSampleHistoryFieldToDisplay,sampleCustodian_cocSampleHistoryFieldToSort,sampleResults_analysisListFieldsToRetrieve,sampleResults_analysisListToDisplay,sampleResults_sampleAnalysisListToDisplay,sampleResults_sampleAnalysisListFieldsToRetrieve,sampleResults_sampleAnalysisResultEntryFieldsToRetrieve,sampleResults_sampleAnalysisResultEntryFieldsToDisplay,sampleResults_sampleAnalysisResultEntryFieldToSort}from"../03config/config-process.js";class EnvMonitElements extends EmDemoAapiEnvMonit(AuthenticationApi(FrontendEnvMonit(connect(store)(PolymerElement)))){static get properties(){return{callBackFunctionEnvMonitElem:Object,schemaPrefix:{type:String,value:schema_name},finalToken:String,backEndData:Object,actionName:String,buttonName:String,analysisListToDisplay:String,givenSampleAnalysisToDisplay:{type:String,value:sampleResults_sampleAnalysisListToDisplay},givenSampleAnalysisEnterResultToDisplay:String,cocUsersListFieldToDisplay:String,cocSampleHistoryFieldToDisplay:String,currTabConfirmUserRequired:Boolean,currTabEsignRequired:Boolean,fieldsDialogAddComment:{type:Array,notify:!0,bubble:!0,value:[{name:"Comment",label_en:"Add Comment",label_es:"A\xF1ade comentario",type:"text",password:"false",read_only:!1,value:""}]},fieldsDialogSetSamplingDate:{type:Array,notify:!0,bubble:!0,value:[{name:"SamplingDate",label_en:"Sampling Date",label_es:"Fecha de Muestreo",type:"date",read_only:!1}]},incubatorsListFieldsToDisplay:{type:Object,value:sampleIncubation_incubBatch_incubatorsFieldToDisplay},selectedBatch:{type:Object}}}static get template(){return html`
        ...
        `}stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.forResultsSamples=state.emDemoA.forResultsSamples;this.analysisList=state.emDemoA.analysisList;this.givenSampleAnalysisList=state.emDemoA.givenSampleAnalysisList;this.givenSampleAnalysisResultEntryList=state.emDemoA.givenSampleAnalysisResultEntryList;this.cocSampleHistory=state.emDemoA.cocSampleHistory;this.cocUsersList=state.emDemoA.cocUsersList;this.activeIncubatorsList=state.emDemoA.allIncubators;if(null!=state.emDemoA.selectedIncubator){this.incubatorName=state.emDemoA.selectedIncubator.name}if(null!=state.emDemoA.selectedBatch){this.selectedBatch=state.emDemoA.selectedBatch}}this.currTabEsignRequired=state.tabs.currTabEsignRequired;this.currTabConfirmUserRequired=state.tabs.currTabConfirmUserRequired}actionTrigger(buttonName,backEndData,buttonDefinition){this.buttonName=buttonName;this.backEndData=backEndData;//    console.log('env-monit-elements >> actionTrigger >> backEndData', backEndData, 'this.backEndData', this.backEndData, 'buttonDefinition', buttonDefinition);  
...
//     break; 
case"INCUBATORSLIST":if(!this.selectedIncubator){dispatchEvent(new CustomEvent("toast-error",{bubbles:!0,composed:!0,detail:"Please select one batch first."}));return}import("../04-procedure/dialogs/em-demo-a-list-modal-batchassignincubator.js");this.getAllIncubators({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix});this.$.incubatorsList.open();break;case"EM_BATCH_INCUB_CREATE":console.log("EM_BATCH_INCUB_CREATE clicked");import("../04-procedure/dialogs/em-demo-a-list-modal-prodlotbrowser.js");this.$.batchBrowser.open();break;case"EM_BATCH_ASSIGN_INCUB":import("../04-procedure/dialogs/em-demo-a-list-modal-batchassignincubator.js");this.getAllIncubators({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix});this.$.incubatorsList.open();break;case"EM_BATCH_INCUB_START":case"EM_BATCH_INCUB_END":var paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&schemaPrefix="+this.schemaPrefix+"&batchName="+this.selectedBatch.name+"&batchtemplateId="+this.selectedBatch.incub_batch_config_id+"&batchtemplateVersion="+this.selectedBatch.incub_batch_config_version;datas.actionName=actionName;datas.paramsUrl=paramsUrl;datas.selectedBatch=this.selectedBatch;datas.callBackFunction=this.refreshWindow.bind(this);this.batchActionTriggerAPI(this.schemaPrefix,this.finalToken,actionName,datas,datas.tabInfo,datas.callBackFunction);break;case"EM_NEW_PRODUCTION_LOT":case"EM_ACTIVATE_PRODUCTION_LOT":import("../04-procedure/dialogs/em-demo-a-list-modal-prodlotbrowser.js");this.$.prodLotBrowser.open();//console.log(actionName + "recognized in env-monit-elements >> actionTriggerNext but not implemented yet");
...
break;case"EM_DEACTIVATE_PRODUCTION_LOT":var paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&schemaPrefix="+this.schemaPrefix+"&lotName="+datas.selectedObject.lot_name;datas.actionName=actionName;datas.paramsUrl=paramsUrl;datas.selectedProdLot=datas.selectedObject.lot_name;datas.callBackFunction=this.refreshWindow.bind(this);this.prodLotActionTriggerAPI(this.schemaPrefix,this.finalToken,actionName,datas,datas.tabInfo,datas.callBackFunction);//console.log(actionName + "recognized in env-monit-elements >> actionTriggerNext but not implemented yet");
...
datas.callBackFunction=this.refreshWindow.bind(this);this.batchActionTriggerAPI(this.schemaPrefix,this.finalToken,actionName,datas,datas.tabInfo,datas.callBackFunction);//datas.selectedObject=this.backEndData.selectedObject;
//this.sampleActionTrigger(actionName, datas, datas.tabInfo);                        
...
datas.callBackFunction=this.refreshWindow.bind(this);this.prodLotActionTriggerAPI(this.schemaPrefix,this.finalToken,actionName,datas,datas.tabInfo,datas.callBackFunction);//datas.selectedObject=this.backEndData.selectedObject;
//this.sampleActionTrigger(actionName, datas, datas.tabInfo);                        
...
datas.callBackFunction=this.callBackFunctionEnvMonitElem.bind(this);datas.temperature=e.detail.value;datas.selectedIncubator=this.backEndData.selectedObject;this.incubationTriggerAPI(this.schemaPrefix,this.finalToken,actionName,datas,datas.tabInfo,datas.callBackFunction);//datas.selectedObject=this.backEndData.selectedObject;
//this.sampleActionTrigger(actionName, datas, datas.tabInfo);                        
