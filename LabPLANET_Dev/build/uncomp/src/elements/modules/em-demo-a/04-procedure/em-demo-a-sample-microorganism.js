import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../internalComponents/grid-components/vaadingrid-singleselect.js";import"./shared-styles.js";import"../01moduleFunctionality/env-monit-elements-sample.js";import{FrontendEnvMonitSample}from"../01moduleFunctionality/frontend-env-monit-sample.js";import{EmDemoAapiEnvMonit}from"../01moduleFunctionality/api-env-monit.js";import{schema_name,sampleMicroorganism_sampleFieldToRetrieve,sampleMicroorganism_sampleFieldToDisplay,sampleMicroorganism_samplesWhereFieldsName,sampleMicroorganism_samplesWhereFieldsValue,sampleMicroorganism_sampleFieldToSort,sampleMicroorganism_buttons}from"../03config/config-process.js";class emDemoASampleMicroorganism extends EmDemoAapiEnvMonit(FrontendEnvMonitSample(connect(store)(PolymerElement))){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},currTabEsignRequired:Boolean,currTabConfirmUserRequired:Boolean,selectedSample:{type:Number},allSamplesStageMicroorganism:{type:Array,notify:!0},sampleFieldToDisplay:{type:Array,value:sampleMicroorganism_sampleFieldToDisplay},samplesWhereFieldsName:{type:String,value:sampleMicroorganism_samplesWhereFieldsName},samplesWhereFieldsValue:{type:String,value:sampleMicroorganism_samplesWhereFieldsValue},selectedObject:{type:Object,notify:!0},buttons:{type:Array,value:sampleMicroorganism_buttons},addSampleAnalysis:{type:Boolean,value:!0},addSampleAnalysisFieldToRetrieve:{type:String,value:""},addSampleAnalysisResult:{type:Boolean,value:!0},addSampleAnalysisResultFieldToRetrieve:{type:String,value:""},callBackRefreshWindow:Object}}dialogButtonClicked(e){console.log("dialogButtonClicked");//this.onFinalTokenFilled();
this.fieldButtonClicked(e)}refreshWindow(){this.onFinalTokenFilled();//this.$.mygridid.clearCache();
}onFinalTokenFilled(){this.callBackRefreshWindow=this.refreshWindow.bind(this);if(!this.finalToken||!this.schemaPrefix){return}this.getAllSamplesStageMicroorganism({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix,actionName:"GET_SAMPLE_MICROORGANISM_VIEW",sampleFieldToRetrieve:sampleMicroorganism_sampleFieldToRetrieve//this.sampleFieldToRetrieve
,samplesTabSortFields:sampleMicroorganism_sampleFieldToSort//this.samplesTabSortFields,
