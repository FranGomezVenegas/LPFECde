...
import"../../internalComponents/form-fields/field-text.js";import"../../internalComponents/form-fields/field-controller.js";import"../../internalComponents/others/language-selector.js";import"../../internalComponents/others/ribbon-element.js";import{AuthenticationApi}from"../mixin/authentication-api.js";import{appLogin_formFields,appLogin_ribbonField}from"../../../config/app-config.js";import{doLogin}from"../Redux/actions/app_actions.js";import{addSession}from"../Redux/actions/session_actions.js";import{UserSession}from"../mixin/api-usersession.js";import{ProcedureList}from"../mixin/app-procedurelist-api.js";import{addTab,setCurrentTab}from"../Redux/actions/tabs_actions.js";import"../../../config/styles/div-style.js";import"../../../config/styles/img-style.js";class AppLogin extends ProcedureList(UserSession(AuthenticationApi(connect(store)(PolymerElement)))){static get properties(){return{axiosErrorMessage:String,//{type: String, notify: true},
...
this.getProcedureList({finalToken:this.finalToken});store.dispatch(addSession(data));var actionName="getAppHeader",paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&personFieldsName="+this.userInfoId,datas=[];datas.finalToken=this.finalToken;datas.actionName=actionName;datas.paramsUrl=paramsUrl;//console.log('app-login >> getAppHeader >> addSession', 'data', data, 'this.userRole', this.userRole);
this.getAppHeader(datas);store.dispatch(doLogin(this.finalToken,this.userName,this.userInfoId))}fieldButtonClicked(e){if("buttonAccess"==e.detail.buttonName){this.login()}}onListChange(e){if("userRole"==e.detail.name){this.doLogin(e.detail.value)}}doLogin(userRole){this.userRole=userRole;this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:userRole})}constructor(){super();return;var curTab=[];this.userName="labplanet";this.userInfoId="1";//return;      
this.dbUserPassword="laslechugas";this.userRole="coordinator";this.formFields[1].value=this.userName;this.formFields[2].value=this.dbUserPassword;this.formFields[3].value=this.userRole;var procObj={name:"em-demo-a"};store.dispatch(addTab({lp_frontend_page_name:"sample-incub-batch",tabName:procObj.name+"-"+"sample-incub-batch",tabLabel_en:procObj.name+"-"+"sample-incub-batch",tabLabel_es:procObj.name+"-"+"sample-incub-batch",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));curTab.tabName=procObj.name+"-"+"sample-incub-batch";curTab.currTabEsignRequired=!1;curTab.currTabConfirmUserRequired=!1;curTab.sops=procObj.sops;store.dispatch(setCurrentTab(curTab));//return;      
...
this.login();this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:this.userRole,dbUserPassword:"laslechugas"});store.dispatch(addTab({lp_frontend_page_name:"browser",tabName:procObj.name+"-"+"browser",tabLabel_en:procObj.name+"-"+"browser",tabLabel_es:procObj.name+"-"+"browser",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));curTab.tabName=procObj.name+"-"+"browser";curTab.currTabEsignRequired=!1;curTab.currTabConfirmUserRequired=!1;curTab.sops=procObj.sops;store.dispatch(setCurrentTab(curTab));return;store.dispatch(addTab({lp_frontend_page_name:"programs",tabName:"em-demo-a"+"-"+"programs",tabLabel_en:"Programs",tabLabel_es:"Programas",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));store.dispatch(addTab({lp_frontend_page_name:"sample-sampling",tabName:procObj.name+"-"+"sample-sampling",tabLabel_en:procObj.name+"-"+"sample-sampling",tabLabel_es:procObj.name+"-"+"sample-sampling",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));store.dispatch(addTab({lp_frontend_page_name:"sample-incub-batch",tabName:procObj.name+"-"+"sample-incub-batch",tabLabel_en:procObj.name+"-"+"sample-incub-batch",tabLabel_es:procObj.name+"-"+"sample-incub-batch",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));// store.dispatch(addTab({ 
