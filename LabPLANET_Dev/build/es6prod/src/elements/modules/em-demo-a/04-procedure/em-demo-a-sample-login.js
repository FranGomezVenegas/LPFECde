define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../store.js","../../../internalComponents/others/ribbon-element.js","../../../internalComponents/form-fields/field-controller.js","../01moduleFunctionality/frontend-env-monit-sample.js","../03config/config-process.js"],function(_polymerElement,_connectMixin,_store,_ribbonElement,_fieldController,_frontendEnvMonitSample,_configProcess){"use strict";class emDemoASampleLogin extends(0,_frontendEnvMonitSample.FrontendEnvMonitSample)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)){stateChanged(state){//console.log('state', state); 
...
// }));
this.schemaPrefix=_configProcess.schema_name;this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.sampleTemplates=state.emDemoA.sampleTemplates;//console.log('stateChanged', 'templates', this.sampleTemplates);
