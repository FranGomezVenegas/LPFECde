define(["../../node_modules/@polymer/polymer/polymer-element.js","../../node_modules/pwa-helpers/connect-mixin.js","../store.js","../../node_modules/@polymer/paper-spinner/paper-spinner-lite.js","./internalComponents/form-fields/field-text.js","./internalComponents/form-fields/field-controller.js","./internalComponents/others/language-selector.js","./internalComponents/others/ribbon-element.js","./internalComponents/dialogs/esign-dialog.js","./internalComponents/dialogs/confirmuser-dialog.js","./app/mixin/authentication-api.js","../config/app-config.js","./app/Redux/actions/app_actions.js","./app/Redux/actions/session_actions.js","./app/Redux/actions/tabs_actions.js"],function(_polymerElement,_connectMixin,_store,_paperSpinnerLite,_fieldText,_fieldController,_languageSelector,_ribbonElement,_esignDialog,_confirmuserDialog,_authenticationApi,_appConfig,_app_actions,_session_actions,_tabs_actions){"use strict";//import {AppStorageBehavior} from '@polymer/app-storage/app-storage-behavior';
//import '@polymer/app-storage/app-localstorage.js';
class PlatformLogin extends(0,_authenticationApi.AuthenticationApi)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)){static get properties(){return{axiosErrorMessage:String,//{type: String, notify: true},
...
userInfoId:String,userRole:{type:String},userRoles:Array,loggedIn:{type:Boolean,observer:"loggedInChanged",notify:!0},formFields:{type:Array,notify:!0,bubble:!0,value:_appConfig.appLogin_formFields},appLoginRibbonField:{type:Object,value:_appConfig.appLogin_ribbonField},appLoginLogoOnTop:{type:String,value:"./images/app-login/labplanet.png"},appLoginFormBackground:{type:String,value:"./images/app-login/login-hexagon-background.png"},appLoginFormBackground2:{type:String,value:"https://cdn5.vectorstock.com/i/1000x1000/90/09/abstract-hexagonal-background-vector-9339009.jpg"}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;this.loggedIn=state.app.user.loggedIn}static get template(){return _polymerElement.html`
      <style>
        #test {
            margin-top: 25px;
            font-size: 21px;
...
var i;for(i=0;i<this.userRoles.length;i++){if(0==i){this.set("formFields.4.items.0.keyName",this.userRoles[0]);this.set("formFields.4.items.0.keyValue_en",this.userRoles[0]);this.set("formFields.4.items.0.keyValue_es",this.userRoles[0])}else{this.push("formFields.4.items",{keyName:this.userRoles[i],keyValue_es:this.userRoles[i],keyValue_en:this.userRoles[i]})}}}initAppSession(){_store.store.dispatch((0,_app_actions.doLogin)(this.finalToken,this.userName,this.userInfoId));var data={sessionId:this.appSessionId,userRole:this.userRole,startDate:this.appSessionStartDate};//console.log('app-login >> initAppSession', 'data', data, 'this.userRole', this.userRole);
_store.store.dispatch((0,_session_actions.addSession)(data))}fieldButtonClicked(e){if("buttonAccess"==e.detail.buttonName){this.login()}}onListChange(e){if("userRole"==e.detail.name){this.doLogin(e.detail.value)}}doLogin(userRole){this.userRole=userRole;this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:userRole})}constructor(){super();this.partialToken="eyJ1c2VyREIiOiJsYWJwbGFuZXQiLCJlU2lnbiI6Im1hbGEiLCJ1c2VyREJQYXNzd29yZCI6Imxhc2xlY2h1Z2FzIiwidHlwIjoiSldUIiwiYXBwU2Vzc2lvbklkIjoiMTIiLCJ1c2VyUm9sZSI6ImNvb3JkaW5hdG9yIiwiYWxnIjoiSFMyNTYiLCJpbnRlcm5hbFVzZXJJRCI6IjEifQ.eyJpc3MiOiJMYWJQTEFORVRkZXN0cmFuZ2lzSW5UaGVOaWdodCJ9.RganJxID3QGqPT210DuJC9b9Wx3U4wFs_0kGVjMuObY";//this.partialToken="eyJ1c2VyREIiOiJqdG9iaWFzIiwiZVNpZ24iOiIiLCJ1c2VyREJQYXNzd29yZCI6ImxlY2h1Z2FzIiwidHlwIjoiSldUIiwiYXBwU2Vzc2lvbklkIjoiIiwidXNlclJvbGUiOiJBZG1pbiIsImFsZyI6IkhTMjU2IiwiaW50ZXJuYWxVc2VySUQiOiIyIn0.eyJpc3MiOiJMYWJQTEFORVRkZXN0cmFuZ2lzSW5UaGVOaWdodCJ9.RZ-RvH4yWa7eyP_etAlq971iG_9HYeMjXJSmXwujoTI";
...
this.userRole="coordinator";this.login();this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:this.userRole});var curTab=[],procObj={name:"em-demo-a"};// store.dispatch(addTab({
...
_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"programs",tabName:"em-demo-a"+"-"+"programs",tabLabel_en:"Programs",tabLabel_es:"Programas",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));curTab.tabName="em-demo-a"+"-"+"programs";curTab.currTabEsignRequired=!1;curTab.currTabConfirmUserRequired=!1;_store.store.dispatch((0,_tabs_actions.setCurrentTab)(curTab));_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"sample-reception",tabName:"em-demo-a"+"-"+"sample-reception",tabLabel_en:"EM Sample Reception",tabLabel_es:"EM Recepci\xF3n Muestras",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));// store.dispatch(addTab({
