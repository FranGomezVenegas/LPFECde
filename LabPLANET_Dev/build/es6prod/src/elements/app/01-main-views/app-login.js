define(["../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../node_modules/pwa-helpers/connect-mixin.js","../../../store.js","../../../../node_modules/@polymer/paper-spinner/paper-spinner-lite.js","../../internalComponents/form-fields/field-text.js","../../internalComponents/form-fields/field-controller.js","../../internalComponents/others/language-selector.js","../../internalComponents/others/ribbon-element.js","../mixin/authentication-api.js","../../../config/app-config.js","../Redux/actions/app_actions.js","../Redux/actions/session_actions.js","../mixin/api-usersession.js","../mixin/app-procedurelist-api.js","../Redux/actions/tabs_actions.js","../../../config/styles/div-style.js","../../../config/styles/img-style.js"],function(_polymerElement,_connectMixin,_store,_paperSpinnerLite,_fieldText,_fieldController,_languageSelector,_ribbonElement,_authenticationApi,_appConfig,_app_actions,_session_actions,_apiUsersession,_appProcedurelistApi,_tabs_actions,_divStyle,_imgStyle){"use strict";//import {AppStorageBehavior} from '@polymer/app-storage/app-storage-behavior';
//import '@polymer/app-storage/app-localstorage.js';
class AppLogin extends(0,_appProcedurelistApi.ProcedureList)((0,_apiUsersession.UserSession)((0,_authenticationApi.AuthenticationApi)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{axiosErrorMessage:String,//{type: String, notify: true},
...
userInfoId:String,userRole:{type:String},userRoles:Array,loggedIn:{type:Boolean,observer:"loggedInChanged",notify:!0},formFields:{type:Array,notify:!0,bubble:!0,value:_appConfig.appLogin_formFields},appLoginRibbonField:{type:Object,value:_appConfig.appLogin_ribbonField},appLoginLogoOnTop:{type:String,value:"./images/app-login/labplanet.png"},rolesList:{type:Array,value:[{keyName:"rutina",keyValue_en:"routine",keyValue_es:"rutina"}]},appLoginFormBackground:{type:String,value:"./images/hexagon-white-blue-light.jpg"},appLoginFormBackgroundBuena:{type:String,value:"./images/app-login/login-hexagon-background.png"},appLoginFormBackground2:{type:String,value:"https://cdn5.vectorstock.com/i/1000x1000/90/09/abstract-hexagonal-background-vector-9339009.jpg"}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;this.loggedIn=state.app.user.loggedIn}static get template(){return _polymerElement.html`
...
this.authenticated=!0;this.dispatchEvent(new CustomEvent("toast-message",{bubbles:!0,composed:!0,detail:"User valid, please select your role to proceed"}));this.loading=!1}authError(e){this.authenticated=!1;this.loading=!1;var msg="User not valid!";//'authError'+this.axiosErrorMessage;
this.set("formFields.1.read_only",!1);// userName
this.set("formFields.2.read_only",!1);// password
this.set("formFields.4.read_only",!0);// roleList    
this.dispatchEvent(new CustomEvent("toast-error",{bubbles:!0,composed:!0,detail:msg}));//console.log('User not valid!', req.statusText);
...
var i;for(i=0;i<this.userRoles.length;i++){var newElement=[{keyName:"",keyValue_en:"",keyValue_es:""}];newElement.keyName=this.userRoles[i];newElement.keyValue_en=this.userRoles[i];newElement.keyValue_es=this.userRoles[i];this.rolesList[i]=newElement}this.set("formFields.4.items",this.rolesList)}initAppSession(){var data={sessionId:this.appSessionId,userRole:this.userRole,startDate:this.appSessionStartDate};// console.log('app-login >> initAppSession >> addSession', 'data', data, 'this.userRole', this.userRole);
this.getProcedureList({finalToken:this.finalToken});_store.store.dispatch((0,_session_actions.addSession)(data));var actionName="getAppHeader",paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&personFieldsName="+this.userInfoId,datas=[];datas.finalToken=this.finalToken;datas.actionName=actionName;datas.paramsUrl=paramsUrl;//console.log('app-login >> getAppHeader >> addSession', 'data', data, 'this.userRole', this.userRole);
this.getAppHeader(datas);_store.store.dispatch((0,_app_actions.doLogin)(this.finalToken,this.userName,this.userInfoId))}fieldButtonClicked(e){if("buttonAccess"==e.detail.buttonName){this.login()}}onListChange(e){if("userRole"==e.detail.name){this.doLogin(e.detail.value)}}doLogin(userRole){this.userRole=userRole;this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:userRole})}constructor(){super();return;var curTab=[];this.userName="labplanet";this.userInfoId="1";//return;      
this.dbUserPassword="laslechugas";this.userRole="coordinator";this.formFields[1].value=this.userName;this.formFields[2].value=this.dbUserPassword;this.formFields[3].value=this.userRole;var procObj={name:"em-demo-a"};_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"sample-incub-batch",tabName:procObj.name+"-"+"sample-incub-batch",tabLabel_en:procObj.name+"-"+"sample-incub-batch",tabLabel_es:procObj.name+"-"+"sample-incub-batch",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));curTab.tabName=procObj.name+"-"+"sample-incub-batch";curTab.currTabEsignRequired=!1;curTab.currTabConfirmUserRequired=!1;curTab.sops=procObj.sops;_store.store.dispatch((0,_tabs_actions.setCurrentTab)(curTab));//return;      
...
this.login();this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:this.userRole,dbUserPassword:"laslechugas"});_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"browser",tabName:procObj.name+"-"+"browser",tabLabel_en:procObj.name+"-"+"browser",tabLabel_es:procObj.name+"-"+"browser",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));curTab.tabName=procObj.name+"-"+"browser";curTab.currTabEsignRequired=!1;curTab.currTabConfirmUserRequired=!1;curTab.sops=procObj.sops;_store.store.dispatch((0,_tabs_actions.setCurrentTab)(curTab));return;_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"programs",tabName:"em-demo-a"+"-"+"programs",tabLabel_en:"Programs",tabLabel_es:"Programas",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"sample-sampling",tabName:procObj.name+"-"+"sample-sampling",tabLabel_en:procObj.name+"-"+"sample-sampling",tabLabel_es:procObj.name+"-"+"sample-sampling",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));_store.store.dispatch((0,_tabs_actions.addTab)({lp_frontend_page_name:"sample-incub-batch",tabName:procObj.name+"-"+"sample-incub-batch",tabLabel_en:procObj.name+"-"+"sample-incub-batch",tabLabel_es:procObj.name+"-"+"sample-incub-batch",procedure:procObj,tabEsignRequired:!1,tabConfirmUserRequired:!1}));// store.dispatch(addTab({ 
