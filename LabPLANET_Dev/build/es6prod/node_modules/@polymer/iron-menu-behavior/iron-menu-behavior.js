...
if((0,_polymerDom.dom)(owner).activeElement==item){return}}}},/**
   ...
   */_applySelection:function(item,isSelected){if(isSelected){item.setAttribute("aria-selected","true")}else{item.removeAttribute("aria-selected")}_ironSelectable.IronSelectableBehavior._applySelection.apply(this,arguments)},/**
