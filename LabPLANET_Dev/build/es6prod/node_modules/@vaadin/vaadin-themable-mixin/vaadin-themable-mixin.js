define(["exports","../../@polymer/polymer/lib/elements/dom-module.js"],function(_exports,_domModule){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ThemableMixin=void 0;/**
 * @polymerMixin
 */const ThemableMixin=superClass=>class VaadinThemableMixin extends superClass{/** @protected */static finalize(){super.finalize();const template=this.prototype._template,hasOwnTemplate=this.template&&this.template.parentElement&&this.template.parentElement.id===this.is,inheritedTemplate=Object.getPrototypeOf(this.prototype)._template;if(inheritedTemplate&&!hasOwnTemplate){// The element doesn't define its own template -> include the theme modules from the inherited template
