...
class processUsSampleLogin extends (FrontendSample(connect(store)(PolymerElement))) {
    stateChanged(state) {       
        ...
        if (state.processUs!=null){
            this.sampleTemplates= state.processUs.sampleTemplates;  
...
customElements.define('process-us-sample-login', processUsSampleLogin);