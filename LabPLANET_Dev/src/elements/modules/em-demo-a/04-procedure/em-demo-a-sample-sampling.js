...
import {schema_name, sampleSampling_sampleFieldToRetrieve, sampleSampling_sampleFieldToDisplay
        ,sampleSampling_sampleFieldToSort, sampleSampling_samplesWhereFieldsValue,
        sampleSampling_samplesWhereFieldsName, sampleSampling_buttons} from '../03config/config-process.js';
import {FieldsMethods} from '../../../app/app-functions/fields-methods';
class emDemoASampleSampling extends FieldsMethods(EmDemoAapiEnvMonit(FrontendEnvMonitSample(connect(store)(PolymerElement)))) {
    static get properties() {
        return {
            ...
            sampleSamplingSampleFieldToDisplay: {
                type: Array, value: sampleSampling_sampleFieldToDisplay
            },
            selectedObject: Object,
            actionCode: Object,
            SamplingButtons:{type: String, value:sampleSampling_buttons},
...
-->
    ...
    itemSelected(e) {
        ...
        var paramsUrl="actionName="+actionName +"&actionName="+actionName  +"&finalToken="+this.finalToken
            ...
            +"&newDate="+this.todayYYYYMMDD()             +"&schemaPrefix="+this.schemaPrefix;
        var datas = [];
    ...
    onFinalTokenFilled(){
        ...
        //console.log('em-demo-a-sample-sampling >> onFinalTokenFilled', this.finalToken, 'this.schemaPrefix', this.schemaPrefix);
        this.getAllSamplesStageSampling({
             finalToken:this.finalToken, schemaPrefix:this.schemaPrefix, actionName:'SAMPLES_BY_STAGE'
            ,sampleFieldToRetrieve:sampleSampling_sampleFieldToRetrieve
            , samplesWhereFieldsName: sampleSampling_samplesWhereFieldsName, samplesWhereFieldsValue: sampleSampling_samplesWhereFieldsValue
            ,samplesSortFieldsName:sampleSampling_sampleFieldToSort
          });         
