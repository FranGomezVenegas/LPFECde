...
import {schema_name
, sampleMicroorganism_sampleFieldToRetrieve, sampleMicroorganism_sampleFieldToDisplay, sampleMicroorganism_samplesWhereFieldsName
, sampleMicroorganism_samplesWhereFieldsValue, sampleMicroorganism_sampleFieldToSort
, sampleMicroorganism_buttons
} from '../03config/config-process.js';
    
class emDemoASampleMicroorganism extends EmDemoAapiEnvMonit(FrontendEnvMonitSample(connect(store)(PolymerElement))) {
    static get properties() {
        return {
            ...
            sampleFieldToDisplay: {type: Array,value: sampleMicroorganism_sampleFieldToDisplay},   
            samplesWhereFieldsName: {type: String, value:sampleMicroorganism_samplesWhereFieldsName},            
            samplesWhereFieldsValue: {type: String, value:sampleMicroorganism_samplesWhereFieldsValue},

            selectedObject:{type: Object, notify:true}, 

            buttons: {type: Array, value: sampleMicroorganism_buttons},
    ...
    dialogButtonClicked(e){
        console.log('dialogButtonClicked');
        //this.onFinalTokenFilled();
        this.fieldButtonClicked(e);
    }
    refreshWindow() {
        this.onFinalTokenFilled();
    ...
    onFinalTokenFilled(){
        ...
        this.getAllSamplesStageMicroorganism({
            ...
            , sampleFieldToRetrieve:sampleMicroorganism_sampleFieldToRetrieve//this.sampleFieldToRetrieve
