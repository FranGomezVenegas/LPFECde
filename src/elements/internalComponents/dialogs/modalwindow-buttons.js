...
import {cancelDialogButton, confirmDialogButton, closeDialogButton} from '../../../config/app-config';
 ...
 * 
 */
class ModalwindowButtons extends FieldsMethods(connect(store)(PolymerElement))  {
...
customElements.define('modalwindow-buttons', ModalwindowButtons);