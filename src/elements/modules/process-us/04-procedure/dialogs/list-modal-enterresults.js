...
class ListModalEnterresults extends (PolymerElement) {
    ...
    enterResult(e){
        ...
        var paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&schemaPrefix="+this.schemaPrefix
         +"&resultId="+resultId  +"&rawValueResult="+rawValue;
        var datas = [];
...
customElements.define('list-modal-enterresults', ListModalEnterresults);