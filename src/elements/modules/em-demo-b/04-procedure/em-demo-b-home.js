...
class emDemoBHome extends FrontendEnvMonitSample(connect(store)(PolymerElement)) {
    stateChanged(state) {
...
//console.log('sampleSummaryChartOptions', this.sampleSummaryChartOptions);
    ...
    openStageTab(){
        console.log('em-demo-b-home >> openStageTab');
    }

}
customElements.define('em-demo-b-home', emDemoBHome);