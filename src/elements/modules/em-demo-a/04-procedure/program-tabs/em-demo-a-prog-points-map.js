...
import '../../../../internalComponents/form-fields/field-text.js'
...
import {schema_name, progProintsMapCardFormButtons, programProgPoints_samplePointsMapTableHeaderFields
...
class EmDemoAProgPointsMap extends FieldsMethods(EmDemoAapiEnvMonit(FrontendEnvMonit(connect(store)(PolymerElement)))) {
    static get properties() {
        return {
            ...
            cardFormButtons:{type: Object, value: progProintsMapCardFormButtons},
            ...
            samplePointsTableHeaderFields: {type: Array, value: programProgPoints_samplePointsMapTableHeaderFields},
...
*/    
    pointClicked(e){
        store.dispatch(setSelectedSamplingPoint(e.currentTarget.cardForm));
        //this.selectedPointCardForm=e.currentTarget.cardForm;
        console.log('em-demo-a-prog-points-map >> pointClicked', this.selectedSamplingPoint );        
        this.$.pointCard.open();
    }
    openDialog(e){
        console.log(e);
    }
    dialogClosedpointCard(){
        console.log('dialogClosedpointCard triggered in vain!');
    }
    editModeToggle(){return !editMode;console.log('editMode', editMode);}
    constructor() {        super();    }
    ready() {        super.ready();    }
    stateChanged(state) {
