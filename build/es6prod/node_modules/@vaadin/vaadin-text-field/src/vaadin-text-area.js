...
`}static get is(){return"vaadin-text-area"}static get version(){return"2.1.6"}static get observers(){return["_textAreaValueChanged(value)"]}ready(){super.ready();this._updateHeight()}_textAreaValueChanged(value){this._updateHeight()}_updateHeight(){const inputField=this.root.querySelector("[part=input-field]"),scrollTop=inputField.scrollTop,input=this.focusElement,inputWidth=getComputedStyle(input).width,valueLength=this.value?this.value.length:0;// Only clear the height when the content shortens to minimize scrollbar flickering.
