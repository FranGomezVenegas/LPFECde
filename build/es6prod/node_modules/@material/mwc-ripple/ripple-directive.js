 ...
 */_exports.rippleNode=rippleNode;const rippleInteractionNodes=new WeakMap,ripple=(options={})=>(0,_litHtml.directive)(part=>{const surfaceNode=part.committer.element,interactionNode=options.interactionNode||surfaceNode;let rippleFoundation=part.value;// if the interaction node changes, destroy and invalidate the foundation.
