define(["exports","./legacy-element-mixin.js","../elements/dom-module.js"],function(_exports,_legacyElementMixin,_domModule){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.mixinBehaviors=mixinBehaviors;_exports.Class=void 0;/**
@license
...
klass=(0,_legacyElementMixin.LegacyElementMixin)(klass);if(!Array.isArray(behaviors)){behaviors=[behaviors]}let superBehaviors=klass.prototype.behaviors;// get flattened, deduped list of behaviors *not* already on super class
...
klass.is=info.is;return klass};_exports.Class=Class});