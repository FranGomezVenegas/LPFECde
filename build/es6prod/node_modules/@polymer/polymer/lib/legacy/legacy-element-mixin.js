...
/**
    ...
    */instanceTemplate(template){let content=this.constructor._contentForTemplate(template),dom=/** @type {!DocumentFragment} */document.importNode(content,!0);return dom}/* **** Begin Events **** */ /**
     ...
     */getEffectiveChildNodes(){const thisEl=/** @type {Element} */this,domApi=/** @type {DomApi} */(0,_polymerDom.dom)(thisEl);return domApi.getEffectiveChildNodes()}/**
     ...
     * @suppress {invalidCasts} LegacyElementMixin must be applied to an HTMLElement
     */queryDistributedElements(selector){const thisEl=/** @type {Element} */this,domApi=/** @type {DomApi} */(0,_polymerDom.dom)(thisEl);return domApi.queryDistributedElements(selector)}/**
     ...
     */getContentChildNodes(slctr){let content=this.root.querySelector(slctr||"slot");return content?/** @type {DomApi} */(0,_polymerDom.dom)(content).getDistributedNodes():[]}/**
