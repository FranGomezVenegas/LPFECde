define(["exports","../utils/boot.js","../utils/settings.js","../utils/mixin.js","../utils/style-gather.js","../utils/resolve-url.js","../elements/dom-module.js","./property-effects.js","./properties-mixin.js"],function(_exports,_boot,_settings,_mixin,_styleGather,_resolveUrl,_domModule,_propertyEffects,_propertiesMixin){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.register=register;_exports.dumpRegistrations=dumpRegistrations;_exports.updateStyles=_exports.registrations=_exports.instanceCount=_exports.ElementMixin=void 0;/**
@license
...
let template=/** @type {PolymerElementConstructor} */this.template;if(template){if("string"===typeof template){console.error("template getter must return HTMLTemplateElement");template=null}else{template=template.cloneNode(!0)}}this.prototype._template=template}/**
     ...
     */static get template(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_template",this))){this._template=_domModule.DomModule&&_domModule.DomModule.import(/** @type {PolymerElementConstructor}*/this.is,"template")||// note: implemented so a subclass can retrieve the super
