define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../store.js","../../../internalComponents/grid-components/vaadingrid-singleselect.js","./shared-styles.js","../01moduleFunctionality/env-monit-elements-sample.js","../01moduleFunctionality/frontend-env-monit-sample.js","../01moduleFunctionality/api-env-monit.js","../03config/config-process.js"],function(_polymerElement,_connectMixin,_store,_vaadingridSingleselect,_sharedStyles,_envMonitElementsSample,_frontendEnvMonitSample,_apiEnvMonit,_configProcess){"use strict";class emDemoASamplePlateReading extends(0,_apiEnvMonit.EmDemoAapiEnvMonit)((0,_frontendEnvMonitSample.FrontendEnvMonitSample)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement))){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},currTabEsignRequired:Boolean,currTabConfirmUserRequired:Boolean,selectedSample:{type:Number},sampleFieldToDisplay:{type:Array,value:_configProcess.samplePlateReading_sampleFieldToDisplay},samplesWhereFieldsName:{type:String,value:_configProcess.samplePlateReading_samplesWhereFieldsName},samplesWhereFieldsValue:{type:String,value:_configProcess.samplePlateReading_samplesWhereFieldsValue},selectedObject:{type:Object,notify:!0},buttons:{type:Array,value:_configProcess.samplePlateReading_buttons},addSampleAnalysis:{type:Boolean,value:!0},addSampleAnalysisFieldToRetrieve:{type:String,value:""},addSampleAnalysisResult:{type:Boolean,value:!0},addSampleAnalysisResultFieldToRetrieve:{type:String,value:""},callBackRefreshWindow:Object}}refreshWindow(){console.log("plate-reading. triggered refreshWindow");this.onFinalTokenFilled();//this.$.mygridid.clearCache();
...
this.getAllSamplesStagePlateReading({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix,actionName:"SAMPLES_BY_STAGE",sampleFieldToRetrieve:_configProcess.samplePlateReading_sampleFieldToRetrieve//this.sampleFieldToRetrieve
,samplesTabSortFields:_configProcess.samplePlateReading_sampleFieldToSort//this.samplesTabSortFields,
