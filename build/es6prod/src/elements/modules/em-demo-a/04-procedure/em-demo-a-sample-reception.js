...
this.getAllProgramsUnreceivedSamples({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix,actionName:"UNRECEIVESAMPLES_LIST",sampleFieldToRetrieve:_configProcess.sampleReception_sampleFieldToRetrieve,whereFieldsName:_configProcess.sampleReception_samplesWhereFieldsName,whereFieldsValue:_configProcess.sampleReception_samplesWhereFieldsValue,sortFieldsName:_configProcess.sampleReception_sampleFieldToSort});//this.actionCode = this.itemSelected.bind(this);
