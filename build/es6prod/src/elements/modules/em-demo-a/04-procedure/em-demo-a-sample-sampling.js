...
class emDemoASampleSampling extends(0,_fieldsMethods.FieldsMethods)((0,_apiEnvMonit.EmDemoAapiEnvMonit)((0,_frontendEnvMonitSample.FrontendEnvMonitSample)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)))){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},selectedSample:Number,allSamplesStageSampling:{type:Array,notify:!0},sampleSamplingSampleFieldToDisplay:{type:Array,value:_configProcess.sampleSampling_sampleFieldToDisplay},selectedObject:Object,actionCode:Object,SamplingButtons:{type:String,value:_configProcess.sampleSampling_buttons},callBackRefreshWindow:Object}}stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.allSamplesStageSampling=state.emDemoA.allSamplesStageSampling}//        if (this.tabIndex!=0){
...
this.getAllSamplesStageSampling({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix,actionName:"SAMPLES_BY_STAGE",sampleFieldToRetrieve:_configProcess.sampleSampling_sampleFieldToRetrieve,samplesWhereFieldsName:_configProcess.sampleSampling_samplesWhereFieldsName,samplesWhereFieldsValue:_configProcess.sampleSampling_samplesWhereFieldsValue,samplesSortFieldsName:_configProcess.sampleSampling_sampleFieldToSort});//this.actionCode = this.itemSelected.bind(this);
