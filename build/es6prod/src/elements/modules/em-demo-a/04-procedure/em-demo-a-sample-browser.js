define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../store.js","../../../../config/styles/cards-style.js","../../../app/Redux/actions/tabs_actions.js","../01moduleFunctionality/frontend-env-monit-sample.js","../00jsonFake/sampleBrowser","../03config/config-process.js"],function(_polymerElement,_connectMixin,_store,_cardsStyle,_tabs_actions,_frontendEnvMonitSample,_sampleBrowser,_configProcess){"use strict";//import '../../internalComponents/pdf-browser-viewer';
class emDemoASampleBrowser extends(0,_frontendEnvMonitSample.FrontendEnvMonitSample)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)){stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.selectedProgram=state.emDemoA.selectedProgram;if(null!=state.emDemoA.sampleBrowserSelectedSample){this.selSample=state.emDemoA.sampleBrowserSelectedSample}}this.schemaPrefix=_configProcess.schema_name}static get properties(){return{selSampleId:{type:Number,value:273},selSample:{type:Object},sampleBrowserSampleFieldToRetrieve:{type:String,value:_configProcess.sampleBrowserSampleFieldToRetrieve},sampleBrowserSampleFieldsToDisplay:{type:String,value:_configProcess.sampleBrowserSampleFieldsToDisplay},goToStageButton:{type:Array,Object,notify:!0,value:{name:"buttonAccess",label_en:"Go",label_es:"Ir",type:"button",value:"",read_only:!1}},sampleBrowserFields:{type:Array,notify:!0,value:[{name:"SampleId",label_en:"Sample",label_es:"Muestra",type:"text",password:"false",value:"273",read_only:!1},{name:"RunReport",label_en:"Report",label_es:"Informe",type:"button",value:"",read_only:!1}]}}}static get template(){return _polymerElement.html`
