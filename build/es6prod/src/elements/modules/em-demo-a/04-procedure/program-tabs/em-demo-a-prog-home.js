...
}static get properties(){return{selectedLanguage:{type:String},sampleSummaryChartType:{type:String,value:"gauge"},selectedProgram:{type:Object},sampleSummaryChartData:{type:Array},sampleSummaryChartOptions:{type:Array,value:""},openTabs:{type:Array},tabOne:{type:String,value:"xxx"},tabOneIsOpen:{type:Boolean},tabTwo:{type:String,value:"em-demo-a-sample-sampling"},tabTwoIsOpen:{type:Boolean},data:{type:Array,value:[["A","B"],[20,45],[31,66],[50,80],[77,50],[68,15]]},tableTitle:{type:Object,value:{label_en:"Home page for the program",label_es:"P\xE1gina de inicio para el programa"}}}}static get template(){return _polymerElement.html`
        <style>
            p.tableTitle{
                margin-top: 0px;
                margin-bottom: 3px;
