define(["../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../node_modules/pwa-helpers/connect-mixin.js","../../../store.js","../../../config/app-config.js","../../app/app-functions/fields-methods.js"],function(_polymerElement,_connectMixin,_store,_appConfig,_fieldsMethods){"use strict";/**
 * `modalwindow-buttons` Description
 *
 * @customElement
 * @polymer
 * @demo
 * 
 */class ModalwindowButtons extends(0,_fieldsMethods.FieldsMethods)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)){static get properties(){return{displayCancelButton:{type:Boolean,value:!1,notify:!0},displayConfirmButton:{type:Boolean,value:!1,notify:!0},displayCloseButton:{type:Boolean,value:!1,notify:!0},cancelDialogButton:{type:String,value:_appConfig.cancelDialogButton},confirmDialogButton:{type:String,value:_appConfig.confirmDialogButton},closeDialogButton:{type:String,value:_appConfig.closeDialogButton},selectedLanguage:{type:String},value:{type:Object}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage}static get template(){return _polymerElement.html`
...
this.dispatchEvent(new CustomEvent("dialog-confirmedbutton-clicked",{bubbles:!0,composed:!0,detail:{buttonName:this.confirmDialogButton.name,value:this.value,buttonDefinition:this.confirmDialogButton}}))}/**
     ...
     * DOM is initialized.
     */ready(){super.ready()}}customElements.define("modalwindow-buttons",ModalwindowButtons)});