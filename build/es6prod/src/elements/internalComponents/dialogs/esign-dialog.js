define(["../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../node_modules/@polymer/paper-button/paper-button.js","../../../../node_modules/@polymer/polymer/lib/elements/dom-if.js","../../../store.js","../../../../node_modules/pwa-helpers/connect-mixin.js","../../app/mixin/authentication-api.js","../../app/Redux/actions/esign-actions.js","../../../config/styles/div-style.js","../../../config/app-config.js","./modalwindow-buttons.js"],function(_polymerElement,_paperButton,_domIf,_store,_connectMixin,_authenticationApi,_esignActions,_divStyle,_appConfig,_modalwindowButtons){"use strict";let acceptedHandler=null,canceledHandler=null;class EsignDialog extends(0,_authenticationApi.AuthenticationApi)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement)){static get properties(){return{dialogButtons:{type:Array,value:_appConfig.dialog_buttons},finalToken:String,opened:{type:Boolean},maximumFailures:Number,numAttempts:{type:Number,observer:"changeAttemptsPhrase"},attemptsPhrase:String,classModal:{type:String,computed:"changeClass(opened)"},formFields:{type:Array,notify:!0,bubble:!0,value:_appConfig.appEsign_formFields},validationNotCorrectMessage:{type:Object,value:_appConfig.appConfirmUserOrEsign_notCorrectMessage},selectedLanguage:{type:String}}}changeAttemptsPhrase(){this.attemptsPhrase="*** Attempts:"+this.numAttempts+" of "+this.maximumFailures;return}changeClass(opened){if(opened){return""}return"closed"}static get template(){return _polymerElement.html`
