define(["../../../../../node_modules/@polymer/polymer/polymer-element.js","../../../../../node_modules/pwa-helpers/connect-mixin.js","../../../../store.js","../../mixin/frontend-sopuser.js","../../mixin/api-sopuser.js","../../../../config/app-config.js","../../../internalComponents/form-fields/field-controller.js","./pdf-link.js","../../../../config/styles/cards-style.js","../../../../config/styles/div-style.js"],function(_polymerElement,_connectMixin,_store,_frontendSopuser,_apiSopuser,_appConfig,_fieldController,_pdfLink,_cardsStyle,_divStyle){"use strict";class MySops extends(0,_apiSopuser.ApiSopUser)((0,_frontendSopuser.FrontendSopUser)((0,_connectMixin.connect)(_store.store)(_polymerElement.PolymerElement))){static get properties(){return{finalToken:{type:String,observer:"onFinalTokenFilled"},allMySops:Array,dialogButtons:{type:Array,value:_appConfig.sopMySops_buttons}}}stateChanged(state){this.finalToken=state.app.user.finalToken;this.allMySops=state.SOPS.userAllSop;//console.log('my-sops', 'this.allMySops', this.allMySops);
