 ...
 */import"./boot.js";import{timeOut,microTask}from"./async.js";import{Debouncer}from"./debounce.js";import{passiveTouchGestures}from"./settings.js";// detect native touch action support
...
document.addEventListener("touchend",ignoreMouse,SUPPORTS_PASSIVE?{passive:!0}:!1);export const gestures={};export const recognizers=[];/**
 ...
 * @return {void}
 */export function setTouchAction(node,value){if(HAS_NATIVE_TA){// NOTE: add touchAction async so that events can be added in
