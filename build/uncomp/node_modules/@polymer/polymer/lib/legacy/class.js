...
*/import{LegacyElementMixin}from"./legacy-element-mixin.js";import{DomModule}from"../elements/dom-module.js";let metaProps={attached:!0,detached:!0,ready:!0,created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,// meta objects
behaviors:!0};/**
 ...
 */export function mixinBehaviors(behaviors,klass){if(!behaviors){klass=/** @type {HTMLElement} */klass;// eslint-disable-line no-self-assign
 ...
 * @return {function(new:HTMLElement)} Generated class
 */export const Class=function(info){if(!info){console.warn(`Polymer's Class function requires \`info\` argument`)}let klass=GenerateClassFromInfo(info,info.behaviors?// note: mixinBehaviors ensures `LegacyElementMixin`.
