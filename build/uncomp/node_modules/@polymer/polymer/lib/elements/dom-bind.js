...
*/import"../utils/boot.js";import{PropertyEffects}from"../mixins/property-effects.js";import{OptionalMutableData}from"../mixins/mutable-data.js";import{GestureEventListeners}from"../mixins/gesture-event-listeners.js";/**
 * @constructor
 * @extends {HTMLElement}
 ...
 */export class DomBind extends domBindBase{static get observedAttributes(){return["mutable-data"]}constructor(){super();this.root=null;this.$=null;this.__children=null}/** @return {void} */attributeChangedCallback(){// assumes only one observed attribute
