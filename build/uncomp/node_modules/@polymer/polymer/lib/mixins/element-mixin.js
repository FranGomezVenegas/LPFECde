...
this.rootPath=rootPath$0;this.importPath=this.constructor.importPath;// apply property defaults...
...
if(this._hasAccessor(p)){this._setPendingProperty(p,value,!0)}else{this[p]=value}}}}/**
    ...
    * @return {void}
    * @protected
    */static _finalizeTemplate(is){/** @const {HTMLTemplateElement} */const template=this.prototype._template;if(template&&!template.__polymerFinalized){template.__polymerFinalized=!0;const importPath=this.importPath,baseURI=importPath?resolveUrl$0(importPath):"";// e.g. support `include="module-name"`, and ShadyCSS
...
"PolymerElement can create dom as children instead of in "+"ShadowDOM by setting `this.root = this;` before `ready`.")}}/**
     ...
     */resolveUrl(url,base){if(!base&&this.importPath){base=resolveUrl$0(this.importPath)}return resolveUrl$0(url,base)}/**
 ...
 * @this {this}
 * @protected
 */export function register(prototype){registrations.push(prototype);void 0}/**
