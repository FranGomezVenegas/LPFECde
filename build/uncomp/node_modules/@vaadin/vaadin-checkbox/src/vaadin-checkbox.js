...
`}static get is(){return"vaadin-checkbox"}static get version(){return"2.2.3"}static get properties(){return{/**
       ...
       */indeterminate:{type:Boolean,notify:!0,observer:"_indeterminateChanged",reflectToAttribute:!0},/**
...
this.addEventListener("keyup",e=>{if(this.__interactionsAllowed(e)&&32===e.keyCode){e.preventDefault();this._toggleChecked();this.removeAttribute("active");if(this.indeterminate){this.indeterminate=!1}}})}get focusElement(){return this.shadowRoot.querySelector("label")}/**
