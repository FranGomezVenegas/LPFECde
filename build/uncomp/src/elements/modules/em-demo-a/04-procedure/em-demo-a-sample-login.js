import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../internalComponents/others/ribbon-element.js";import"../../../internalComponents/form-fields/field-controller.js";import{FrontendEnvMonitSample}from"../01moduleFunctionality/frontend-env-monit-sample.js";import{schema_name,sampleLogin_formFields,sampleLogin_ribbonField}from"../03config/config-process.js";class emDemoASampleLogin extends FrontendEnvMonitSample(connect(store)(PolymerElement)){stateChanged(state){//console.log('state', state); 
...
// }));
this.schemaPrefix=schema_name;this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.sampleTemplates=state.emDemoA.sampleTemplates;//console.log('stateChanged', 'templates', this.sampleTemplates);
