import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../../../node_modules/@polymer/paper-button/paper-button.js";import"../../../internalComponents/cards/card-form.js";import"../../../internalComponents/grid-components/vaadingrid-singleselect.js";import"../01moduleFunctionality/env-monit-elements-sample.js";import"./shared-styles.js";import"../../../../config/styles/cards-style.js";import{FrontendEnvMonitSample}from"../01moduleFunctionality/frontend-env-monit-sample.js";import"./em-demo-a-batches.js";import{FieldsMethods}from"../../../app/app-functions/fields-methods.js";import{setCurrentTab}from"../../../app/Redux/actions/tabs_actions.js";import{schema_name,sampleIncubation1_incubBatch_sampleFieldToRetrieve,sampleIncubation1_incubBatch_sampleFieldToDisplay,sampleIncubation1_incubBatch_samplesWhereFieldsName,sampleIncubation1_incubBatch_samplesWhereFieldsValue,sampleIncubation1_incubBatch_sampleFieldToSort,sampleIncubation1_incubBatch_buttons,sampleIncubation2_incubBatch_sampleFieldToRetrieve,sampleIncubation2_incubBatch_sampleFieldToDisplay,sampleIncubation2_incubBatch_samplesWhereFieldsName,sampleIncubation2_incubBatch_samplesWhereFieldsValue,sampleIncubation2_incubBatch_sampleFieldToSort,sampleIncubation2_incubBatch_buttons}from"../03config/config-process.js";class emDemoASampleIncubBatch extends FieldsMethods(FrontendEnvMonitSample(connect(store)(PolymerElement))){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},currTabEsignRequired:Boolean,currTabConfirmUserRequired:Boolean,selectedSample:{type:Number},Incubation1Buttons:{type:Array,value:sampleIncubation1_incubBatch_buttons},sampleIncubation1FieldToDisplay:{type:Array,value:sampleIncubation1_incubBatch_sampleFieldToDisplay},samplesIncubation1WhereFieldsName:{type:String,value:sampleIncubation1_incubBatch_samplesWhereFieldsName},samplesIncubation1WhereFieldsValue:{type:String,value:sampleIncubation1_incubBatch_samplesWhereFieldsValue},Incubation2Buttons:{type:Array,value:sampleIncubation2_incubBatch_buttons},sampleIncubation2FieldToDisplay:{type:Array,value:sampleIncubation2_incubBatch_sampleFieldToDisplay},samplesWhereFieldsName:{type:String,value:sampleIncubation2_incubBatch_samplesWhereFieldsName},samplesWhereFieldsValue:{type:String,value:sampleIncubation2_incubBatch_samplesWhereFieldsValue},buttons:{type:Array,value:sampleIncubation2_incubBatch_buttons},selectedBatch:{type:Object},callBackRefreshWindow:Object,tabsInfo:Object,selectedLanguage:String,sampleIncubation1TableTitle:{type:Object,value:{label_en:"Samples Pending 1st Incubation",label_es:"Muestras pendientes de la 1\xAA incubaci\xF3n"}},sampleIncubation2TableTitle:{type:Object,value:{label_en:"Samples Pending 2nd Incubation",label_es:"Muestras pendientes de la 2\xAA incubaci\xF3n"}}}}refreshWindow(){this.onFinalTokenFilled();//this.$.mygridid.clearCache();
}onFinalTokenFilled(){this.callBackRefreshWindow=this.refreshWindow.bind(this);if(!this.finalToken||!this.schemaPrefix){return}this.getAllSamplesStageIncubation2({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix,actionName:"SAMPLES_BY_STAGE",sampleFieldToRetrieve:sampleIncubation2_incubBatch_sampleFieldToRetrieve//this.sampleFieldToRetrieve
...
,samplesWhereFieldsName:this.samplesIncubation1WhereFieldsName,samplesWhereFieldsValue:this.samplesIncubation1WhereFieldsValue});var i;for(i=0;i<this.tabsInfo.length;i++){if("em-demo-a-sample-incub-batch"==this.tabsInfo[i].tabName){var curTab={lp_frontend_page_name:this.tabsInfo[i].lp_frontend_page_name,tabName:this.tabsInfo[i].tabName,tabLabel_en:this.tabsInfo[i].tabLabel_en,tabLabel_es:this.tabsInfo[i].tabLabel_es,procedure:this.tabsInfo[i].procedure,tabEsignRequired:this.tabsInfo[i].tabEsignRequired,tabConfirmUserRequired:this.tabsInfo[i].tabConfirmUserRequired};store.dispatch(setCurrentTab(curTab))}}//console.log('refreshing batches');
...
this.currTabEsignRequired=state.tabs.currTabEsignRequired;this.currTabConfirmUserRequired=state.tabs.currTabConfirmUserRequired}if(state.tabs.tabs){this.tabsInfo=state.tabs.tabs}this.schemaPrefix=schema_name}//     createIncubatorsList(){
//         var i;
