...
import"../01moduleFunctionality/env-monit-elements-sample.js";import{FrontendEnvMonitSample}from"../01moduleFunctionality/frontend-env-monit-sample.js";import{EmDemoAapiEnvMonit}from"../01moduleFunctionality/api-env-monit.js";import{schema_name,personSampling_sampleFieldToRetrieve,personSampling_sampleFieldToDisplay,personSampling_sampleFieldToSort,personSampling_samplesWhereFieldsValue,personSampling_samplesWhereFieldsName,personSampling_buttons}from"../03config/config-process.js";import{FieldsMethods}from"../../../app/app-functions/fields-methods.js";class emDemoAPersonSampling extends FieldsMethods(EmDemoAapiEnvMonit(FrontendEnvMonitSample(connect(store)(PolymerElement)))){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},selectedSample:Number,allSamplesStageSampling:{type:Array,notify:!0},sampleSamplingSampleFieldToDisplay:{type:Array,value:personSampling_sampleFieldToDisplay},selectedObject:Object,actionCode:Object,SamplingButtons:{type:String,value:personSampling_buttons},callBackRefreshWindow:Object}}stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.allSamplesStageSampling=state.emDemoA.allSamplesStageSampling}//        if (this.tabIndex!=0){
