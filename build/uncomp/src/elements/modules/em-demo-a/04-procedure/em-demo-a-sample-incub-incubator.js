import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../../../node_modules/@polymer/paper-button/paper-button.js";import"../../../internalComponents/cards/card-form.js";import"../../../internalComponents/grid-components/vaadingrid-singleselect.js";import"../01moduleFunctionality/env-monit-elements-sample.js";import"./shared-styles.js";import"./shared-styles.js";import"../../../../config/styles/cards-style.js";import{setSelectedIncubator}from"../02Redux/em-demo-a_actions.js";import{FrontendEnvMonitSample}from"../01moduleFunctionality/frontend-env-monit-sample.js";import{schema_name,sampleIncubation1_sampleFieldToRetrieve,sampleIncubation1_sampleFieldToDisplay,sampleIncubation1_samplesWhereFieldsName,sampleIncubation1_samplesWhereFieldsValue,sampleIncubation1_sampleFieldToSort,sampleIncubation1_buttons,sampleIncubation2_sampleFieldToRetrieve,sampleIncubation2_sampleFieldToDisplay,sampleIncubation2_samplesWhereFieldsName,sampleIncubation2_samplesWhereFieldsValue,sampleIncubation2_sampleFieldToSort,sampleIncubation2_buttons,sampleCustodian_cocSampleHistoryFieldToDisplay,sampleCustodian_cocSampleHistoryWhereFieldsName,sampleCustodian_cocSampleHistoryWhereFieldsValue,sampleCustodian_cocSampleHistoryFieldToSort,sampleCustodian_cocSampleHistoryButtons}from"../03config/config-process.js";class emDemoASampleIncubIncubator extends FrontendEnvMonitSample(connect(store)(PolymerElement)){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},currTabEsignRequired:Boolean,currTabConfirmUserRequired:Boolean,selectedSample:{type:Number},cocSampleHistoryFieldToDisplay:{type:Array,value:sampleCustodian_cocSampleHistoryFieldToDisplay},cocSampleHistoryWhereFieldsName:{type:String,value:sampleCustodian_cocSampleHistoryWhereFieldsName},cocSampleHistoryWhereFieldsValue:{type:String,value:sampleCustodian_cocSampleHistoryWhereFieldsValue},Incubation1Buttons:{type:Array,value:sampleIncubation1_buttons},sampleFieldToDisplayCustodian:{type:Array,value:sampleIncubation1_sampleFieldToDisplay},samplesWhereFieldsNameCustodian:{type:String,value:sampleIncubation1_samplesWhereFieldsName},samplesWhereFieldsValueCustodian:{type:String,value:sampleIncubation1_samplesWhereFieldsValue},Incubation2Buttons:{type:Array,value:sampleIncubation2_buttons},sampleFieldToDisplay:{type:Array,value:sampleIncubation2_sampleFieldToDisplay},samplesWhereFieldsName:{type:String,value:sampleIncubation2_samplesWhereFieldsName},samplesWhereFieldsValue:{type:String,value:sampleIncubation2_samplesWhereFieldsValue},buttons:{type:Array,value:sampleIncubation2_buttons},incubationsList:{type:Array},incubationListElement:{type:Array,value:[{name:"shift",label_en:"Shift",label_es:"Turno",type:"list",dbType:"String",value:"Admin",read_only:!1,items:this.incubationsList}]},callBackRefreshWindow:Object}}refreshWindow(){this.onFinalTokenFilled();//this.$.mygridid.clearCache();
...
this.set("incubform.0.items",this.rolesList)}selectedIncubator(e){console.log("selectedIncubator");var data=[];data.name="INC_1";store.dispatch(setSelectedIncubator(data))}static get template(){return html`
