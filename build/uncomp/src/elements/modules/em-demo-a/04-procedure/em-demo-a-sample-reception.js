...
import{FrontendEnvMonitSample}from"../01moduleFunctionality/frontend-env-monit-sample.js";import{EmDemoAapiEnvMonit}from"../01moduleFunctionality/api-env-monit.js";import{schema_name,sampleReception_sampleFieldToRetrieve,sampleReception_sampleFieldToDisplay,sampleReception_sampleFieldToSort,sampleReception_samplesWhereFieldsValue,sampleReception_samplesWhereFieldsName}from"../03config/config-process.js";class emDemoASampleReception extends EmDemoAapiEnvMonit(FrontendEnvMonitSample(connect(store)(PolymerElement))){static get properties(){return{finalToken:String,schemaPrefix:{type:String,observer:"onFinalTokenFilled"},selectedSample:Number,allProgramsUnreceivedSamples:{type:Array,notify:!0},sampleReceptionSampleFieldToDisplay:{type:Array,value:sampleReception_sampleFieldToDisplay},selectedObject:Object,actionCode:Object}}stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){this.allProgramsUnreceivedSamples=state.emDemoA.allProgramsUnreceivedSamples}//        if (this.tabIndex!=0){
...
}onFinalTokenFilled(){if(!this.finalToken||!this.schemaPrefix){return}//console.log('em-demo-a-sample-reception >> onFinalTokenFilled', this.finalToken, 'this.schemaPrefix', this.schemaPrefix);
this.getAllProgramsUnreceivedSamples({finalToken:this.finalToken,schemaPrefix:this.schemaPrefix,actionName:"UNRECEIVESAMPLES_LIST",sampleFieldToRetrieve:sampleReception_sampleFieldToRetrieve,whereFieldsName:sampleReception_samplesWhereFieldsName,whereFieldsValue:sampleReception_samplesWhereFieldsValue,sortFieldsName:sampleReception_sampleFieldToSort});//this.actionCode = this.itemSelected.bind(this);
