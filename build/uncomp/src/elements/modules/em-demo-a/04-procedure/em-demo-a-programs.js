import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import"../../../../../node_modules/@polymer/paper-tabs/paper-tabs.js";import"../../../../../node_modules/@polymer/paper-tabs/paper-tab.js";import"../../../../../node_modules/@polymer/iron-pages/iron-pages.js";import{isTabOpn}from"../03config/config-process.js";//import '../../internalComponents/pdf-browser-viewer';
import{schema_name,em_programs_tabs,programMain_programSelection,programHome_defaultTab//    , sampleReception_sampleFieldToRetrieve, sampleReception_sampleFieldToDisplay
}from"../03config/config-process.js";import{FrontendEnvMonit}from"../01moduleFunctionality/frontend-env-monit.js";import{setSelectedProgram}from"../02Redux/em-demo-a_actions.js";import"./program-tabs/em-demo-a-prog-home.js";import"./program-tabs/em-demo-a-prog-configcalendar.js";import"./program-tabs/em-demo-a-prog-limits.js";import"./program-tabs/em-demo-a-prog-points.js";import"./program-tabs/em-demo-a-prog-points-map.js";import"./program-tabs/em-demo-a-prog-corrective-actions.js";class emDemoAPrograms extends FrontendEnvMonit(connect(store)(PolymerElement)){stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.tabs.tabs){this.appOpenTabs=state.tabs.tabs}if(null!=state.emDemoA){this.programs=state.emDemoA.programs;if(null!=this.programs){this.fillProgramsList()}}if(null!=state.app.user.appProcedureList.procedures){this.procedure=state.app.user.appProcedureList.procedures[2]}this.selectedLanguage=state.app.user.appLanguage}static get properties(){return{schemaPrefix:{type:String,value:schema_name},thisTabName:{type:String,value:"em-demo-a-programs"},appOpenTabs:{type:String,observer:"onFinalTokenFilled"},finalToken:{type:String},programsList:{type:Array,notify:!0,bubble:!0,value:programMain_programSelection},programs:Object,tabs:{type:Object,value:em_programs_tabs},currentTab:[],currentSubTab:{type:String,value:programHome_defaultTab//currentTab: {type:Object, value:'home'},
},procedure:Array,selectedLanguage:String}}static get template(){return html`
        <style>
        div {            
            width: 80%;
            height: 80%;
...
if(isTabOpn(this.appOpenTabs,this.thisTabName)){this.getActivePrograms();//   var actionName='GET_ACTIVE_PRODUCTION_LOTS';
...
store.dispatch(setSelectedProgram(this.programs[e.detail.index]));//console.log('em-demo-a-programas, programSelected', this.$.programSelected.value, 'e', e);
