import{PolymerElement,html}from"../../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../../store.js";import"../../../../../../node_modules/@polymer/polymer/lib/elements/dom-if.js";import"../../../../../config/styles/cards-style.js";import{addTab,setCurrentTab}from"../../../../app/Redux/actions/tabs_actions.js";import{FrontendEnvMonitSample}from"../../01moduleFunctionality/frontend-env-monit-sample.js";//import '../../internalComponents/pdf-browser-viewer';
import{tableFieldLabel}from"../../03config/tablefield_labels.js";import"../../01moduleFunctionality/env-monit-elements.js";import{schema_name,browserBatchFieldToRetrieve,browserBatchFieldsToDisplay,browserBatchNoContent}from"../../03config/config-process.js";class emDemoABrBatch extends tableFieldLabel(FrontendEnvMonitSample(connect(store)(PolymerElement))){stateChanged(state){this.finalToken=state.app.user.finalToken;if(null!=state.emDemoA){if(null!=state.emDemoA.browserSelectedBatch){this.selBatch=state.emDemoA.browserSelectedBatch;if(null!=this.selBatch.lastTemperatureReadings){var i;this.selBatchTempReadings=[["Time","Temperature"]];if(!this.selBatch.lastTemperatureReadings){this.displayChart=!1;return}if(this.selBatch.lastTemperatureReadings[0].error){this.displayChart=!1;return}this.displayChart=!0;for(i=0;i<this.selBatch.lastTemperatureReadings.length;i++){if(!this.selBatch.lastTemperatureReadings[i].error){this.selBatchTempReadings.push([this.selBatch.lastTemperatureReadings[i].created_on,this.selBatch.lastTemperatureReadings[i].temperature])}}this.selectedObject=this.selBatch.batchFieldToRetrieve.name}}}this.schemaPrefix=schema_name;this.selectedLanguage=state.app.user.appLanguage}static get properties(){return{displayChart:Boolean,finalToken:{type:String},schemaPrefix:{type:String},selectedLanguage:String,selBatchTempReadings:{type:Array},selBatchName:{type:Number,value:"Tanda4"},selBatch:{type:Object},browserBatchFieldToRetrieve:{type:String,value:browserBatchFieldToRetrieve},browserBatchFieldsToDisplay:{type:String,value:browserBatchFieldsToDisplay},goToStageButton:{type:Array,Object,notify:!0,value:{name:"buttonAccess",label_en:"Go",label_es:"Ir",type:"button",value:"",read_only:!1}},browserBatchFields:{type:Array,notify:!0,value:[{name:"BatchName",label_en:"Batch",label_es:"Tanda",type:"text",password:"false",value:"Tanda4",read_only:!1},{name:"RunReport",label_en:"Report",label_es:"Informe",type:"button",value:"",read_only:!1}]},tableFieldLabelSchemaName:{type:String,value:"data"},tableFieldLabelTableName:{type:String,value:"Batch"},NoContent:{type:Array,notify:!0,value:browserBatchNoContent}}}static get template(){return html`
