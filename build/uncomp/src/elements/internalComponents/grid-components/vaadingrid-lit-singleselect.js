...
import"../../../../node_modules/@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../node_modules/@vaadin/vaadin-grid/vaadin-grid-filter-column.js";import"../../../../node_modules/@vaadin/vaadin-grid/vaadin-grid-sort-column.js";import"../../../../node_modules/@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../../node_modules/@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../node_modules/@vaadin/vaadin-checkbox/vaadin-checkbox.js";class vaadingridLitSingleSelect extends LitElement{static get properties(){return{rowcontainer:{//hasChanged: () => true // see https://github.com/Polymer/lit-element/issues/107#issuecomment-416376381     
...
//   });
    ...
    `}indexRenderer(root,column,rowData){return;render(html`
        <div>${rowData.index}</div>
      `,root)}addressRenderer(root,column,rowData){return;render(html`
        <span class="address">${rowData.item.address.street}, ${rowData.item.address.city}</span>
      `,root)}emailHeaderRenderer(root){return;render(html`
