import{PolymerElement,html}from"../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../store.js";import"../../../../node_modules/@vaadin/vaadin-text-field/vaadin-text-field.js";import"../../../../node_modules/@vaadin/vaadin-text-field/vaadin-text-area.js";import"../../../../node_modules/@vaadin/vaadin-text-field/vaadin-password-field.js";import{FieldsMethods}from"../../app/app-functions/fields-methods.js";class FieldTextArea extends FieldsMethods(connect(store)(PolymerElement)){static get properties(){return{field:{type:Object,observer:"fieldChange",notify:!0},type:{type:String,notify:!0},value:{type:String,notify:!0},fieldClass:String,iAm:{type:Object,value:function(){return{button:!1,checkBox:!1}}}}}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage}textClass(langApp){if("en"==langApp){this.fieldClass="x-field.myCustomFieldRed";return}this.fieldClass="x-field.myCustomFieldBlue";return}textType(){var isPwd=this.textTypePassword();if(isPwd)return!1;var isConfid=this.textTypeConfidential();if(isConfid)return!1;return!0}textTypePassword(){return"true"==this.field.password}textTypeConfidential(){return"confidential"==this.field.password}fieldChange(newField){switch(newField.showDisplayPasswordType){case"Button":this.set("iAm.button",!0);break;case"CheckBox":this.set("iAm.checkBox",!0);break;}}static get template(){return html`    
    <style>
