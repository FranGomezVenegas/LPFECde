import{PolymerElement,html}from"../../../../node_modules/@polymer/polymer/polymer-element.js";import"../../../../node_modules/@polymer/paper-button/paper-button.js";import"../../../../node_modules/@polymer/polymer/lib/elements/dom-if.js";import{store}from"../../../store.js";import{connect}from"../../../../node_modules/pwa-helpers/connect-mixin.js";import{AuthenticationApi}from"../../app/mixin/authentication-api.js";import"../form-fields/field-controller.js";import{CloseOnEscPressed}from"../../app/mixin/close-on-esc-pressed-mixin.js";import{closeConfirmUserDialog,resetAndCloseConfirmUserDialog,confirmUserSuccess,confirmUserFailure}from"../../app/Redux/actions/confirmuser-actions.js";import{dialog_buttons,appConfirmUser_formFields,appConfirmUserOrEsign_notCorrectMessage}from"../../../config/app-config.js";import"../../../config/styles/div-style.js";let acceptedHandler=null,canceledHandler=null,numConfirmations=null;import"./modalwindow-buttons.js";class ConfirmUserDialog extends CloseOnEscPressed(AuthenticationApi(connect(store)(PolymerElement))){static get properties(){return{dialogButtons:{type:Array,value:dialog_buttons},finalToken:String,opened:{type:Boolean},maximumFailures:Number,numAttempts:{type:Number,observer:"changeAttemptsPhrase"},attemptsPhrase:String,classModal:{type:String,computed:"changeClass(opened)"},formFields:{type:Array,notify:!0,bubble:!0,value:appConfirmUser_formFields},validationNotCorrectMessage:{type:Object,value:appConfirmUserOrEsign_notCorrectMessage},selectedLanguage:{type:String}}}changeAttemptsPhrase(){this.attemptsPhrase="*** Attempts:"+this.numAttempts+" of "+this.maximumFailures;return}changeClass(opened){if(opened){return""}return"closed"}static get template(){return html`
