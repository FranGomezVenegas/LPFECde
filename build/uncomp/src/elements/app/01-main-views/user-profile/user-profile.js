import{PolymerElement,html}from"../../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../../store.js";import{AuthenticationApi}from"../../mixin/authentication-api.js";import{changeUserPasswordForm,changeUserEsignForm,saveOpenTabsForm}from"../../../../config/app-config.js";import{Appapi}from"../../mixin/api-app.js";import{schema_name}from"../../../modules/process-us/03config/config-process.js";import"../../mixin/app-elements.js";import"../../../../config/styles/cards-style.js";/**
 ...
 * @demo
 * 
 */class UserProfile extends Appapi(AuthenticationApi(connect(store)(PolymerElement))){stateChanged(state){console.log("user-Profile.js >> stateChanged >> this.userInfo",this.userInfo);this.finalToken=state.app.user.finalToken;this.userInfo=state.app.user;this.tabsOpen=state.tabs.tabs}static get properties(){return{schemaPrefix:{type:String,value:schema_name},finalToken:{type:String},userInfo:{type:Object},tabsOpen:{type:Object},changeUserPasswordForm:{type:Array,value:changeUserPasswordForm},changeUserEsignForm:{type:Array,value:changeUserEsignForm},saveOpenTabsForm:{type:Array,value:saveOpenTabsForm}}}static get template(){return html`
