...
if(isTabOpn(this.appOpenTabs,this.thisTabName)){this.getUserOpenIncidents({finalToken:this.finalToken})}var curTab={lp_frontend_page_name:"incidents/new-incident.js",tabName:"new-incident",tabLabel_en:"New Issue",tabLabel_es:"Nueva Incidencia",procedure:"incident",tabEsignRequired:!1,tabConfirmUserRequired:!1};store.dispatch(setCurrentTab(curTab));if(this.selectedItem){console.log("onFinalTokenFilled",this.selectedItem);this.selectedObject=this.selectedItem;//this.$.mygridid.selectedItems=[];
