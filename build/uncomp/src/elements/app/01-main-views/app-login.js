import{PolymerElement,html}from"../../../../node_modules/@polymer/polymer/polymer-element.js";import{connect}from"../../../../node_modules/pwa-helpers/connect-mixin.js";import{store}from"../../../store.js";import"../../../../node_modules/@polymer/paper-spinner/paper-spinner-lite.js";import"../../internalComponents/form-fields/field-text.js";import"../../internalComponents/form-fields/field-controller.js";import"../../internalComponents/others/language-selector.js";import"../../internalComponents/others/ribbon-element.js";import{AuthenticationApi}from"../mixin/authentication-api.js";import{appLogin_formFields,appLogin_ribbonField,userProfileHome,appLogin_authenticationMessage,sopUserPendingSop_fieldToRetrieve,sopUserAllSop_fieldToRetrieve}from"../../../config/app-config.js";import{doLogin,startLoading}from"../Redux/actions/app_actions.js";import{addSession}from"../Redux/actions/session_actions.js";import{UserSession}from"../mixin/api-usersession.js";import{ProcedureList}from"../mixin/app-procedurelist-api.js";import{FrontendSopUser}from"../mixin/frontend-sopuser.js";import{addTab,setCurrentTab,addSystemTab}from"../Redux/actions/tabs_actions.js";import"../../../config/styles/div-style.js";import"../../../config/styles/img-style.js";class AppLogin extends FrontendSopUser(ProcedureList(UserSession(AuthenticationApi(connect(store)(PolymerElement))))){static get properties(){return{axiosMessage:{type:String,value:appLogin_authenticationMessage},finalToken:{type:String,notify:!0},loading:{type:Boolean,value:!1},partialToken:String,partialTokenn:String,sessionId:String,appSessionStartDate:String,userName:String,password:String,userInfoId:String,userTabsOnLogin:String,userRole:{type:String},userRoles:Array,loggedIn:{type:Boolean,observer:"loggedInChanged",notify:!0},formFields:{type:Array,notify:!0,bubble:!0,value:appLogin_formFields},appLoginRibbonField:{type:Object,value:appLogin_ribbonField},appLoginLogoOnTop:{type:String,value:"./images/app-login/labplanet.png"},rolesList:{type:Array,value:[{keyName:"rutina",keyValue_en:"routine",keyValue_es:"rutina"}]},appLoginFormBackground:{type:String,value:"./images/hexagon-white-blue-light.jpg"},appLoginFormBackgroundBuena:{type:String,value:"./images/app-login/login-hexagon-background.png"},appLoginFormBackground2:{type:String,value:"https://cdn5.vectorstock.com/i/1000x1000/90/09/abstract-hexagonal-background-vector-9339009.jpg"},selectedLanguage:String}}static get template(){return html`
...
var tabsLogin="";if(this.userTabsOnLogin){tabsLogin=this.userTabsOnLogin}var data={sessionId:this.appSessionId,userRole:this.userRole,startDate:this.appSessionStartDate,userTabsOnLogin:tabsLogin};this.getProcedureList({finalToken:this.finalToken,callBackFunction:this.getAllMySops.bind(this),callBackFunction2:this.getMyPendingSops.bind(this)});store.dispatch(addSession(data));var actionName="getAppHeader",paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&personFieldsName="+this.userInfoId,datas=[];datas.finalToken=this.finalToken;datas.actionName=actionName;datas.paramsUrl=paramsUrl;this.openTabsOnLogin(this.userTabsOnLogin);this.getAppHeader(datas);store.dispatch(doLogin(this.finalToken,this.userName,this.userInfoId,this.userTabsOnLogin))}fieldButtonClicked(e){if("buttonAccess"==e.detail.buttonName){this.login()}}getMyPendingSops(){var actionName="MY_PENDING_SOPS",paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&sopFieldsToRetrieve="+sopUserPendingSop_fieldToRetrieve,datas=[];datas.finalToken=this.finalToken;datas.actionName=actionName;datas.paramsUrl=paramsUrl;this.frontEndSopUserAPI(datas)}getAllMySops(){var actionName="ALL_MY_SOPS",paramsUrl="actionName="+actionName+"&finalToken="+this.finalToken+"&sopFieldsToRetrieve="+sopUserAllSop_fieldToRetrieve,datas=[];datas.finalToken=this.finalToken;datas.actionName=actionName;datas.paramsUrl=paramsUrl;this.frontEndSopUserAPI(datas)}onListChange(e){if("userRole"==e.detail.name){this.doLogin(e.detail.value)}}doLogin(userRole){this.userRole=userRole;store.dispatch(startLoading());this.ajaxFinalToken({actionName:"finaltoken",partialToken:this.partialToken,userRole:userRole})}openTabsOnLogin(tabsInfo){if(!tabsInfo){return}var i;for(i=0;i<tabsInfo.length;i++){//if (tabsInfo[i].tabName!='user-profile'){
...
}}store.dispatch(setCurrentTab(curTab))}stateChanged(state){this.selectedLanguage=state.app.user.appLanguage;this.loggedIn=state.app.user.loggedIn;// this.focus(); Intento de poner el foco en el primer campo de formulario
