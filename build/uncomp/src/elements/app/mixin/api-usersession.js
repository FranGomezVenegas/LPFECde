...
import{addNotification}from"../Redux/actions/notifications_actions.js";import{userInfo}from"../Redux/actions/app_actions.js";/**
 * @mixinFunction
 * @polymer
...
store.dispatch(userInfo(response.data));//if (data.callBackFunction){data.callBackFunction();}
