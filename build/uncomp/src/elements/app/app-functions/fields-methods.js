...
if(!langApp&&!field){console.log("methods.js","labelValue with no langApp recognized","field=",field,"langApp=",langApp);return""}if("en"==langApp){if(field.label_en){return field.label_en}if(field.message_en){return field.message_en}//console.log("methods.js", "labelValue with no label_es recognized", 'field=', field, 'langApp=', langApp );            
return""}if("es"==langApp){if(field.label_es){return field.label_es}if(field.message_es){return field.message_es}//console.log("methods.js", "labelValue with no label_es recognized", 'field=', field, 'langApp=', langApp );            
return""}return field.label_en}tabLabelValue(langApp,field){//        console.log("methods.js", "labelValue", "langApp="+langApp, field);
